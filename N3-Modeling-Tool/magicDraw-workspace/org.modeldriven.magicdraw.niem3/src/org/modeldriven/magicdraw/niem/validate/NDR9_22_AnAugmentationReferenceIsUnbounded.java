 ...
 *
 */
public class NDR9_22_AnAugmentationReferenceIsUnbounded extends NameValidationRule 
	//implements Expression
{
	public NDR9_22_AnAugmentationReferenceIsUnbounded(){}
    /**
     * {@inheritDoc}
     */
    @Override
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
		...
		return subsetProperty.getUpper()>=0;
	 	}
/* no fix
    @Override
