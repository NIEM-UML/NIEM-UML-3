...
*/
	...
	*/
	public List<Property> getOwnedAttributes() {
		return super.getOwnedAttribute();
	}
	...
	public EList<Property> getAttributes() {
		...
		if (cache != null) {
			...
			EList<Property> attributes = (EList<Property>) cache.get(eResource,
				this,
				MdkernelPackage.Literals.CLASSIFIER__ATTRIBUTE);
			if (attributes == null) {
				cache
					.put(
						eResource,
...
//			EList<Property> features = getOwnedAttributes();
			List<Property> features = getOwnedAttributes();
			...
			if (features.isEmpty()) {
				...
				List<? extends TypedElement> typedElements;
				if (getReferredOperation() != null) {
					typedElements = getReferredOperation().getOwnedParameter();
...
//		return properties;
		return new BasicEList<Property>(properties);
	}
