...
public class ReferencesPackageExpression extends BaseValidationRule implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	if(Package.class.isInstance(object)){
    		...
    		return NIEMHelper.getReferencesReferenceModelInformationModel(subsetInformationModel);
    	}
    	return null;
    }
