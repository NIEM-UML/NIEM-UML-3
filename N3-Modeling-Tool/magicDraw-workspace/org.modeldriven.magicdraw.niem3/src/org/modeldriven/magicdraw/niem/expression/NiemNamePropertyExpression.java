...
public class NiemNamePropertyExpression extends BaseValidationRule implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
   	if(Property.class.isInstance(object)){
    		return NameHelper.getNIEMName((Property)object);
    	}
    	return "";
    }
  ...
  public Map<java.lang.Class<? extends Element>, Collection<SmartListenerConfig>> getListenerConfigurations()
  {
    ...
    addPropertyConfiguration(configs);
    /*
...
//    classCfg.listenToNested(PropertyNames.OWNED_ATTRIBUTE).listenTo(PropertyNames.TYPE);
    ...
    configs.put(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property.class, Collections.singletonList(classCfg));
    */
    return configs;
  }
}
