 ...
 * @generated
 */
public class OCLUMLFactoryImpl
		extends EFactoryImpl
		implements OCLUMLFactory {
	 ...
	 * @generated
	 */
	public static OCLUMLFactory init() {
		/* this returns UMLFactory, not OCLUMLFactory
		try {
			OCLUMLFactory theUMLFactory = (OCLUMLFactory) EPackage.Registry.INSTANCE
