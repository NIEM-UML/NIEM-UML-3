...
/**
 * Validation rule for AssociationType name.
 *
 */
public class NDR7_14_AssociationTypeOpeningPhrase extends OpeningPhraseRule
{
	@Override
	protected String getOpeningPhrase() {
		return "A data type for a relationship ";
	}

	@Override
	protected boolean isComponentClass(Element namedElement) {
		return NIEMHelper.isAssociationType(((Type)namedElement));
	}
