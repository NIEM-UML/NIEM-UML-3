 ...
 *
 */
public class NDR4_01_ConformantIndicator extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
    	...
    	return !NIEMHelper.getNamespaceIsConformant((Package)namedElement);
	 	}

    @Override
    protected Annotation createAnnotation(Element element, Constraint constraint)
    {
    	FixIsConformantAction action = new FixIsConformantAction((NamedElement) element);
        return new Annotation(element, constraint, Collections.singletonList(action));
    }
    ///////////////////////////////////////////////
    static public class FixIsConformantAction extends FixNameAction implements AnnotationAction
    {

        public FixIsConformantAction(NamedElement property)
        {
            super(property);
            setName("set conformant indicator");
        }
        protected void fixName(Element ne){
        	Package informationModel=(Package)ne;
    		NIEMHelper.setNamespaceIsConformant(informationModel,true);
        }
    }
