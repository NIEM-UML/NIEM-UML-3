...
public class NiemAugmentationElementsExpression extends NiemNameClassifierExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	...
    	if(Classifier.class.isInstance(object)){
    		...
    		for(Generalization generalization:clientClassifier.getGeneralization()){
    			...
    			if(NIEMHelper.isAugmentationType(general)&&!NIEMHelper.isAugmentationType(clientClassifier)){
