 ...
 *
 */
public class NDR9_18_AnAugmentationPointHasNoType extends NameValidationRule 
	//implements Expression
{
	public NDR9_18_AnAugmentationPointHasNoType(){}
    /**
     * {@inheritDoc}
     */
    @Override
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
    	...
    	return subsetProperty.getType()!=null;
	 	}
/* no fix
    @Override
