 ...
 *
 */
public class NDR7_14_AbstractElementOpeningPhrase extends OpeningPhraseRule
{
	@Override
	protected String getOpeningPhrase() {
		return "A data concept for a";
	}

	@Override
	protected boolean isComponentClass(Element namedElement) {
		return NIEMHelper.isAbstractElement((Property)namedElement);
	}
