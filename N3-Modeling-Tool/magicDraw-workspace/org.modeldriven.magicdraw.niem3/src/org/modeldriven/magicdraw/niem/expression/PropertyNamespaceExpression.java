...
public class PropertyNamespaceExpression extends NiemNamePropertyExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	if(Property.class.isInstance(object)){
    		...
    		Property holder= NameHelper.getSubsetPropertyHolderProperty(subsetProperty);
    		if(holder==null)holder=subsetProperty;
    		return NIEMHelper.getNearestInformationModel(holder);
    	}
    	return null;
    }
