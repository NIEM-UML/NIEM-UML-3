 ...
 *
 */
public class NDR8_78_SchemaHasDataDefinition extends DocumentationRule
{
     protected boolean isElementInvalid(Element namedElement){
 		...
 		if(!NIEMHelper.isInformationModelDefaultPurposeExtensionOrReference((Package)namedElement))return false;
