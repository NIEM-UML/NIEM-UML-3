...
public class MpdSchemaPackagesComponentExpression extends BaseValidationRule implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
   	if(Component.class.isInstance(object)){
    		Component mpd=(Component)object;
    		return NIEMHelper.getModelPackageDescriptionInformationModels(mpd);
    	}
  ...
  public Map<java.lang.Class<? extends Element>, Collection<SmartListenerConfig>> getListenerConfigurations()
  {
    ...
    addComponentAppliedStereotypeConfiguration(configs);
    /*
