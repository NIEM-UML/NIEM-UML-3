 ...
 *
 */
public class NDR10_18_ElementSubstitutionGroupIsFromConformantNamespace extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
	   	 ...
	   	 for(Property substitution:property.getSubsettedProperty()){
	   		 //if(!(NIEMHelper.isInInformationModel(substitution)))return true;
	   		if(!NIEMHelper.isImportedAsConformantNamespace(NIEMHelper.getNearestPackage(property)))return true;
	   	 }
	   	 return false;
	 	}
