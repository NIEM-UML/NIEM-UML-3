 ...
 *
 */
public class NDR9_21_AnAugmentationReferenceIsOptional extends NameValidationRule 
	//implements Expression
{
	public NDR9_21_AnAugmentationReferenceIsOptional(){}
    /**
     * {@inheritDoc}
     */
    @Override
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
		...
		return subsetProperty.getLower()!=0;
	 	}
/* no fix
    @Override
