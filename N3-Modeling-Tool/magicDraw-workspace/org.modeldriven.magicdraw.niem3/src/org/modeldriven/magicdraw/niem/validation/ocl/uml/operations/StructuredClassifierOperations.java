...
public class StructuredClassifierOperations
	...
	static public Property createOwnedAttribute(StructuredClassifier structuredClassifier,String name, Type type, EClass eClass) {
		Property newOwnedAttribute = (Property) create(eClass);
		structuredClassifier.getOwnedAttribute().add(newOwnedAttribute);
		if (name != null)
	...
	static public Property createOwnedAttribute(StructuredClassifier structuredClassifier,String name, Type type) {
		return createOwnedAttribute(structuredClassifier,name, type, UMLPackage.Literals.PROPERTY);
	}
