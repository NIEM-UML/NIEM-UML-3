...
/**
 * Entry point of the 'PsmValidate' generation module.
 *
 * @override
 */
public class PsmValidate extends CommonGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/modeldriven/magicdraw/niem/m2t/psmValidate";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "psmValidate" };
  ...
  /**
	 ...
	 * @generated
	 */
	public PsmValidate(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public PsmValidate(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                PsmValidate generator = new PsmValidate(modelURI, folder, arguments);
