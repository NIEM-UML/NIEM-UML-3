 ...
 *
 */
public class NDR10_19_AttributeTypeIsFromConformantNamespace extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
	   	 ...
	   	 if(!NIEMHelper.isXSDAttribute((Property)namedElement))return false;
	   		 ...
	   		 if(type!=null){
	   		   	 Package typeModel=NIEMHelper.getNearestPackage(type);
	   		   	 return !NIEMHelper.isImportedAsConformantNamespace(typeModel);
	   		 }
//	   		 if((type!=null)&&!(NIEMHelper.isInInformationModel(type)||NIEMHelper.isXMLPrimitiveType((Classifier)type)))return true;
	   	 return false;
	 	}
