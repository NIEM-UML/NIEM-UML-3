 ...
 *
 */
public class NDR8_45_AttributeDeclarationDataDefinitionIsNotEmpty extends NDR8_44_AttributeDeclarationHasDefinition
{
    protected boolean isDataDefinitionInvalid(Element namedElement){
    	return(super.isDataDefinitionEmpty(namedElement));
     }
