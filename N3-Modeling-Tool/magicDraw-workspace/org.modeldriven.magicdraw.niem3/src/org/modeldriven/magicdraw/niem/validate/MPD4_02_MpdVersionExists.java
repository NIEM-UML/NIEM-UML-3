 ...
 *
 */
public class MPD4_02_MpdVersionExists extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
    	...
    	String mpdVersion=NIEMHelper.getMpdVersionID(mpd);
    	return (mpdVersion==null)||(mpdVersion.length()==0);
	 	}
