...
/**
 * Entry point of the 'OmgRfpNiem' generation module.
 *
 * @override
 */
public class OmgRfpNiem extends CommonGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/modeldriven/magicdraw/niem/m2t/OmgRfpNiem";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "OmgRfpNiem" };
  ...
  /**
	 ...
	 * @generated
	 */
	public OmgRfpNiem(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public OmgRfpNiem(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                OmgRfpNiem generator = new OmgRfpNiem(modelURI, folder, arguments);
