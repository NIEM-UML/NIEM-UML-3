...
public class NIEMQVTPlugin extends com.nomagic.magicdraw.plugins.Plugin
		implements NIEM_ProfileConstants
// TODO: re-enable license			, LicensedPlugin 
			{
...
//	    return "2012.10.19";// does nothing?
	...
	public void init() {
// TODO: need new inf.properties for NIEM-3
if(false)		
	...
	protected void configureProjectCache(){
		...
		projectsManager.addProjectListener(new ProjectEventListenerAdapter(){
			...
			public void 	projectDeActivated(Project project){
				System.out.println("projectDeActivated start");
				ProjectCache.removeProject(project);
				System.out.println("projectDeActivated done");
			}
			public void 	projectCreated(Project project){
				System.out.println("projectCreated start");
				ProjectCache.getProjectCache(project);
				System.out.println("projectCreated end");
			}
			public void 	projectActivated(Project project){
				System.out.println("projectActivated start");
				ProjectCache.getProjectCache(project);
				System.out.println("projectActivated end");
			}
			*/
		});
	}
