 ...
 *
 */
public class NDR10_07_UnionItemTypesDefinedByConformantSchemas extends NDR8_12_NoUnionItemTypeOfxs_ID
{
    protected boolean isItemInvalid(DataType ne){
		 return(!(NIEMHelper.isInImportedAsConformantNamespace(ne)));
    }
    @Override
