...
public class CombinedFragmentOperations
	...
	public static boolean validateOptLoopBreakNeg(
		...
		switch (((InteractionOperatorKindEnum)combinedFragment.getInteractionOperator()).getValue()) {
//		switch (combinedFragment.getInteractionOperator().getValue()) {
			case InteractionOperatorKindEnum.OPT_VALUE :
			case InteractionOperatorKindEnum.LOOP_VALUE :
			case InteractionOperatorKindEnum.NEG_VALUE :
			case InteractionOperatorKindEnum.BREAK_VALUE :
				if (combinedFragment.getOperand().size() != 1) {
	...
	public static boolean validateMinintAndMaxint(
		...
		if (combinedFragment.getInteractionOperator() != InteractionOperatorKindEnum.LOOP) {
