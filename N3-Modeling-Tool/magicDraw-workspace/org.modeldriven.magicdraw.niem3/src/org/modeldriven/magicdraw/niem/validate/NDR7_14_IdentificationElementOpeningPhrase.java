 ...
 *
 */
public class NDR7_14_IdentificationElementOpeningPhrase extends OpeningPhraseRule
{
	protected String getOpeningPhraseMatch() {
		return "(?s)"+"A[n]? .*identification .*";
	}
...
//			&&isIndicator(namedElement.getName());
			&&isIdentification(NameHelper.getNIEMName((Property)namedElement));
	}
