...
import org.modeldriven.magicdraw.niem.validation.ocl.uml.operations.GeneralizationOperations;
import org.modeldriven.magicdraw.niem.validation.ocl.uml.operations.InterfaceOperations;
...
import org.modeldriven.magicdraw.niem.validation.ocl.uml.operations.SignalOperations;
import org.modeldriven.magicdraw.niem.validation.ocl.uml.operations.StereotypeOperations;
import org.modeldriven.magicdraw.niem.validation.ocl.uml.operations.StructuredClassifierOperations;
...
//import com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdtemplates.metadata.MdtemplatesFactory;
...
//import com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces.metadata.MdinterfacesFactory;
...
public class UMLUtil
	...
	public static class ProfileApplicationHelper {
		...
		public Iterable<Package> getOtherApplyingPackages(
				Package package_) {
			return NamedElementOperations.allOwningPackages(package_);
		}
	}
...
*/
	...
	public static class QualifiedTextProvider
		...
		public String getSeparator() {
			return NamedElementOperations.SEPARATOR;
		}
	...
	public static class PackageMerger
		...
		protected class BodyMatcher
			...
			protected BodyMatcher(Comment comment) {
				super(comment, com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.COMMENT__BODY);
			}
		}
		...
		protected class NameMatcher
			...
			protected NameMatcher(NamedElement namedElement) {
				super(namedElement, com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.NAMED_ELEMENT__NAME);
			}
		}
		...
		protected class StringValueMatcher
			...
			public boolean matches(EObject otherEObject) {
				return super.matches(otherEObject)
					&& safeEquals(ValueSpecificationOperations.stringValue((ValueSpecification) eObject),
							ValueSpecificationOperations.stringValue((ValueSpecification) otherEObject));
			}
		}
					...
					return (type == null && otherType == null)
						...
						|| (type instanceof Classifier
							&& otherType instanceof Classifier && (findEObject(
									ClassifierOperations.allParents(((Classifier) type)),
							new ResultingQNameMatcher(otherType)) != null || findEObject(
									ClassifierOperations.allParents(((Classifier) otherType)),
...
/*
		protected <EO extends EObject> List<EO> getMatchCandidates(EO eObject) {
			...
			if (baseElement == null) {
				...
				@SuppressWarnings("unchecked")
//				List<EO> stereotypeApplications = (List<EO>) ((Element) get(baseElement)).getStereotypeApplications();
				List<EO> stereotypeApplications = (List<EO>) ElementOperations.getStereotypeApplications(((Element) get(baseElement)));
...
*/
		...
		protected void mergeAssociation_IsDerived(
			...
			receivingAssociation.setDerived(receivingAssociation.isDerived()
		...
		protected void mergeClassifier_IsAbstract(
			...
			receivingClassifier.setAbstract(receivingClassifier.isAbstract()
		...
		protected void mergeMultiplicityElement_IsOrdered(
			...
			receivingMultiplicityElement
				.setOrdered(receivingMultiplicityElement.isOrdered()
		...
		protected void mergeMultiplicityElement_IsUnique(
				...
				MultiplicityElement mergedMultiplicityElement) {
			receivingMultiplicityElement
				.setUnique(receivingMultiplicityElement.isUnique()
		...
		protected void mergeNamedElement_Visibility(
			...
			if (receivingNamedElement.getVisibility() == VisibilityKindEnum.PRIVATE
				&& mergedNamedElement.getVisibility() == VisibilityKindEnum.PRIVATE) {

				receivingNamedElement
					.setVisibility(VisibilityKindEnum.PRIVATE);
//			} else if (receivingNamedElement.isSetVisibility()) {
			} else if (NamedElementOperations.isSetVisibility(receivingNamedElement)) {
				receivingNamedElement
					.setVisibility(VisibilityKindEnum.PUBLIC);
			}
		}

		protected void mergeProperty_IsDerived(Property receivingProperty,
				Property mergedProperty) {
			receivingProperty.setDerived(receivingProperty.isDerived()
				|| mergedProperty.isDerived());
		}

		protected void mergeProperty_IsDerivedUnion(Property receivingProperty,
				Property mergedProperty) {
			receivingProperty.setDerivedUnion(receivingProperty
				.isDerivedUnion()
		...
		protected void mergeStructuralFeature_IsReadOnly(
			...
			receivingStructuralFeature.setReadOnly(receivingStructuralFeature
				.isReadOnly()
		...
		protected void copyAttribute(EAttribute eAttribute, EObject eObject,
			...
			if (eObject != copyEObject) {
				...
				if (copyEObject == receivingPackage) {
					...
					if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.ASSOCIATION__IS_DERIVED) {
						mergeAssociation_IsDerived((Association) copyEObject,
							(Association) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.CLASSIFIER__IS_ABSTRACT) {
						mergeClassifier_IsAbstract((Classifier) copyEObject,
							(Classifier) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.LITERAL_INTEGER__VALUE
						&& copyEObject.eContainingFeature() == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.MULTIPLICITY_ELEMENT__LOWER_VALUE) {

						mergeLiteralInteger_Value((LiteralInteger) copyEObject,
							(LiteralInteger) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.LITERAL_UNLIMITED_NATURAL__VALUE
						&& copyEObject.eContainingFeature() == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.MULTIPLICITY_ELEMENT__UPPER_VALUE) {

						mergeLiteralUnlimitedNatural_Value(
							(LiteralUnlimitedNatural) copyEObject,
							(LiteralUnlimitedNatural) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.MULTIPLICITY_ELEMENT__IS_ORDERED) {
						mergeMultiplicityElement_IsOrdered(
							(MultiplicityElement) copyEObject,
							(MultiplicityElement) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.MULTIPLICITY_ELEMENT__IS_UNIQUE) {
						mergeMultiplicityElement_IsUnique(
							(MultiplicityElement) copyEObject,
							(MultiplicityElement) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.NAMED_ELEMENT__VISIBILITY) {
						mergeNamedElement_Visibility(
							(NamedElement) copyEObject, (NamedElement) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.PROPERTY__IS_DERIVED) {
						mergeProperty_IsDerived((Property) copyEObject,
							(Property) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.PROPERTY__IS_DERIVED_UNION) {
						mergeProperty_IsDerivedUnion((Property) copyEObject,
							(Property) eObject);
					} else if (eAttribute == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.STRUCTURAL_FEATURE__IS_READ_ONLY) {
		...
		protected void mergeTypedElement_Type(
			...
			if (receivingType != null && mergedType instanceof Classifier) {
				EList<Classifier> allParents = ClassifierOperations.allParents(((Classifier) mergedType));
		...
		protected void copyReference(EReference eReference, EObject eObject,
			...
			if (eObject != copyEObject && eObject.eIsSet(eReference)) {
				...
				if (eReference == com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.TYPED_ELEMENT__TYPE) {
...
/*
		...
		protected EObject createCopy(EObject eObject) {
			return new UMLSwitch<EObject>() {
				...
				@Override
				public EObject caseClass(Class class_) {
					Class matchingClass = (Class) findEObject(
						...
						new EClassMatcher(directedRelationship) {
							...
							public boolean matches(EObject otherEObject) {
								...
								if (super.matches(otherEObject)) {
									...
									Collection<Element> targets = ((DirectedRelationship) eObject)
										.getTarget();
									Collection<Element> otherTargets = ((DirectedRelationship) otherEObject)
										.getTarget();
				...
				for (TreeIterator<EObject> eAllContents = ((EObject) object)
					...
					if (childEObject instanceof Element) {
						...
						Collection<T> copies = (Collection<T>) super
							.copyAll(ElementOperations.getStereotypeApplications(((Element) childEObject)));
							//.copyAll(((Element) childEObject).getStereotypeApplications());
...
*/
		protected Collection<Package> getAllMergedPackages(
				Package package_) {
			return getAllMergedPackages(package_,
				new UniqueEList.FastCompare<Package>());
		}

		private Collection<Package> getAllMergedPackages(
				Package package_,
				Collection<Package> allMergedPackages) {
		...
		private Collection<Package> getAllMergedPackages(
				Package package_,
				Collection<Package> allMergedPackages,
				Collection<Package> visitedPackages) {

			for (PackageMerge packageMerge : package_.getPackageMerge()) {
				Package mergedPackage = packageMerge
					.getMergedPackage();
		...
		protected void processInvalidSubsets(Map<String, String> options,
			...
			for (EObject resultingEObject : resultingToMergedEObjectMap
				...
				if (resultingEObject instanceof Property) {
					...
					Collection<Property> subsettedProperties = subsettingProperty
...
//									UMLPlugin.INSTANCE
						...
						unionProperty.setDerivedUnion(false);
					} else if (OPTION__REPORT.equals(options
						.get(OPTION__EMPTY_UNIONS))
						&& diagnostics != null) {
		...
		protected void processRedundantGeneralizations(
			...
			for (EObject resultingEObject : resultingToMergedEObjectMap
				...
				if (resultingEObject instanceof Classifier) {
					...
					Collection<Generalization> generalizations = classifier
						.getGeneralization();
					...
					for (Generalization generalization : new ArrayList<Generalization>(
						...
						if (general != null) {
							EList<Classifier> generalAllParents = ClassifierOperations.allParents(general);
...
//									&& !otherGeneralization.hasKeyword("extend")) { //$NON-NLS-1$
									&& !GeneralizationOperations.hasKeyword(otherGeneralization,"extend")) { //$NON-NLS-1$
...
//													UMLPlugin.INSTANCE
										...
										g.remove();
										GeneralizationOperations.destroy(otherGeneralization);
			...
			for (EObject resultingEObject : resultingToMergedEObjectMap
				...
				if (resultingEObject instanceof Association) {
					...
					for (Association generalAssociation : generalAssociations) {
						...
						if (!ClassifierOperations.allParents(association).contains(
							generalAssociation)) {
...
//											UMLPlugin.INSTANCE
								...
								//association.createGeneralization(generalAssociation);
								AssociationOperations.createGeneralization(association,generalAssociation);
							} else if (OPTION__REPORT.equals(options
								.get(OPTION__ASSOCIATION_SPECIALIZATIONS))
								&& diagnostics != null) {
		...
		protected void processCapabilities(Map<String, String> options,
			...
			for (Map.Entry<EObject, List<EObject>> entry : resultingToMergedEObjectMap
				...
				if (resultingEObject instanceof RedefinableElement) {
					Package resultingPackage = ElementOperations.getNearestPackage(((RedefinableElement) resultingEObject));

					for (EObject mergedEObject : entry.getValue()) {
						Package mergedPackage = ElementOperations.getNearestPackage(((Element) mergedEObject));
...
*/
		...
		public Map<EObject, List<EObject>> merge(
			...
			for (Iterator<PackageMerge> packageMerges = receivingPackage
				.getPackageMerge().iterator(); packageMerges.hasNext();) {
...
//								UMLPlugin.INSTANCE
		...
		protected EClassifier getEType(Type type) {
			...
			if (type != null) {
				...
				if (!isEmpty(qualifiedName) && type instanceof com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PrimitiveType) {
...
//			return element.getAppliedStereotype("Ecore" //$NON-NLS-1$
		...
		public static boolean isEDataType(Namespace namespace) {
			return !new UMLSwitch<Boolean>() {
				...
				@Override
				public Boolean caseClass(Class class_) {
					return Boolean.TRUE;
				}
				...
				@Override
				public Boolean casePrimitiveType(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PrimitiveType primitiveType) {
					return Boolean.FALSE;
				}
		...
		public Object caseClass(Class class_) {
			...
			if (!isEGenericType(class_) && !ClassOperations.isTemplateParameter(class_)) {
//			if (!isEGenericType(class_) && !class_.isTemplateParameter()) {
				Package package_ = ElementOperations.getNearestPackage(class_);
		...
		public Object caseComment(Comment comment) {
			...
			if (!isEmpty(body) && options != null
				...
				for (Element annotatedElement : comment.getAnnotatedElement()) {
...
//						addDocumentation(eModelElement, specification.stringValue());
						addDocumentation(eModelElement, ValueSpecificationOperations.stringValue(specification));
					}
		...
		public Object caseDataType(DataType dataType) {
			...
			if (!isEGenericType(dataType) && !DataTypeOperations.isTemplateParameter(dataType)) {
//			if (!isEGenericType(dataType) && !dataType.isTemplateParameter()) {
				Package package_ = ElementOperations.getNearestPackage(dataType);
		...
		@Override
		public Object caseEModelElement(ModelObject eModelElement) {
			return eModelElement;
		}

		@Override
		public Object caseEnumeration(Enumeration enumeration) {
			Package package_ = ElementOperations.getNearestPackage(enumeration);
		...
		public Object caseEnumerationLiteral(
			...
			if (enumeration != null) {
				...
				int value = enumeration.getOwnedLiteral().indexOf(
					enumerationLiteral);
...
//						value = specification.integerValue();
						value = ValueSpecificationOperations.integerValue(specification);
					} catch (Exception e) {
						// ignore
					}
				}
		...
		public Object caseInterface(Interface interface_) {
			...
			if (!isEGenericType(interface_)
					&& !InterfaceOperations.isTemplateParameter(interface_)) {
//				&& !interface_.isTemplateParameter()) {

				Package package_ = ElementOperations.getNearestPackage(interface_);
		...
		public Object caseOperation(Operation operation) {
			...
			if (isEClass(namespace)) {
				...
				for (Type raisedException : operation.getRaisedException()) {
		...
		public Object casePackage(Package package_) {
			...
			if (!packages.contains(package_)) {
				Package nestingPackage = package_
					.getNestingPackage();
		...
		public Object caseParameter(Parameter parameter) {
			...
			if (operation != null
				&& parameter.getDirection() != ParameterDirectionKindEnum.RETURN) {
			...
			if (templateParameter != null) {
				...
				if (signature != null) {
					...
					if (eTypeParameters != null) {
						...
						int index = signature.getParameter().indexOf(
							templateParameter);
		...
		@Override
		public Object casePrimitiveType(com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PrimitiveType primitiveType) {

			if (!isEGenericType(primitiveType)
				&& !primitiveType.isTemplateParameter()) {

				Package package_ = ElementOperations.getNearestPackage(primitiveType);
			...
			if (isEClass(namespace)) {
				...
				if (isEClass(type)) {
					...
					if (default_ != null) {
						...
						if (type instanceof com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PrimitiveType
							&& safeEquals(
								"UMLPrimitiveTypes::UnlimitedNatural", type.getQualifiedName())) {//$NON-NLS-1$

							default_ = UMLFactory.eINSTANCE
								.createFromString(
									com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.UNLIMITED_NATURAL,
									default_).toString();
...
//								UMLPlugin.INSTANCE
					...
					if (eStructuralFeature != null) {
						...
						if (propertyName == TAG_DEFINITION__XML_CONTENT_KIND) {
							...
							if (value == EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__EMPTY)) {

								ExtendedMetaData.INSTANCE.setContentKind(
									(EClass) eModelElement,
									ExtendedMetaData.EMPTY_CONTENT);
							} else if (value == EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__SIMPLE)) {

								ExtendedMetaData.INSTANCE.setContentKind(
									(EClass) eModelElement,
									ExtendedMetaData.SIMPLE_CONTENT);
							} else if (value == EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__MIXED)) {

								ExtendedMetaData.INSTANCE.setContentKind(
									(EClass) eModelElement,
									ExtendedMetaData.MIXED_CONTENT);
							} else if (value == EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__ELEMENT_ONLY)) {
							...
							if (value == EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__SIMPLE)) {

								ExtendedMetaData.INSTANCE.setFeatureKind(
									(EStructuralFeature) eModelElement,
									ExtendedMetaData.SIMPLE_FEATURE);
							} else if (value == EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ATTRIBUTE)) {

								ExtendedMetaData.INSTANCE.setFeatureKind(
									(EStructuralFeature) eModelElement,
									ExtendedMetaData.ATTRIBUTE_FEATURE);
							} else if (value == EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ATTRIBUTE_WILDCARD)) {

								ExtendedMetaData.INSTANCE
									.setFeatureKind(
										(EStructuralFeature) eModelElement,
										ExtendedMetaData.ATTRIBUTE_WILDCARD_FEATURE);
							} else if (value == EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ELEMENT)) {

								ExtendedMetaData.INSTANCE.setFeatureKind(
									(EStructuralFeature) eModelElement,
									ExtendedMetaData.ELEMENT_FEATURE);
							} else if (value == EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ELEMENT_WILDCARD)) {

								ExtendedMetaData.INSTANCE.setFeatureKind(
									(EStructuralFeature) eModelElement,
									ExtendedMetaData.ELEMENT_WILDCARD_FEATURE);
							} else if (value == EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__GROUP)) {
							...
							if (eModelElement instanceof EOperation) {
								...
								if (value == EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__NONE)) {
								...
								} else if (value == EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__READ_ONLY)) {
								...
								} else if (value == EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__READ_WRITE)) {
								...
								} else if (value == EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__READ_ONLY_UNSETTABLE)) {
...
//											UMLPlugin.INSTANCE
		...
		public Collection<? extends EObject> convert(
			...
			packages = EcoreUtil.getObjectsByType(eObjects,
				com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.PACKAGE);
	...
	public static class Profile2EPackageConverter
		...
		public Object caseProfile(Profile profile) {
			...
			if (packages.contains(profile)) {
				...
				Package nestingPackage = profile
					.getNestingPackage();
...
/*	
	public static class Ecore2UMLConverter
		...
		protected class ParameterSubstitutionMatcher
			...
			@Override
			public boolean matches(EObject otherEObject) {
				Collection<TemplateParameterSubstitution> parameterSubstitutions = ((TemplateBinding) eObject)
					.getParameterSubstitution();
				Collection<TemplateParameterSubstitution> otherParameterSubstitutions = ((TemplateBinding) otherEObject)
					.getParameterSubstitution();
		...
		protected Model getEcorePrimitiveTypesLibrary(
			...
			if (resourceSet != null) {
				return load(resourceSet, URI
					...
					com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.MODEL);
			}
		...
		protected com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PrimitiveType getEcorePrimitiveType(
			...
			return ecorePrimitiveTypesLibrary != null
				? (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PrimitiveType) PackageOperations.getOwnedType(ecorePrimitiveTypesLibrary,name)
				: null;
		}
		...
		protected PrimitiveType getXMLPrimitiveType(
			...
			return xmlPrimitiveTypesLibrary != null
				? (PrimitiveType) PackageOperations.getOwnedType(xmlPrimitiveTypesLibrary,name)
				: null;
		}
				...
				if (eClassifier != null) {
					...
					if (isTemplate(eClassifier)) {
						...
						for (DirectedRelationship relationship : templateSignature
							.getTargetDirectedRelationships(com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.TEMPLATE_BINDING)) {
						...
						if (boundElement == null) {
							...
							boundElement.getTemplateBinding().add(
								templateBinding);
		...
		protected EList<Type> getOwnedTypes(EModelElement eModelElement) {
			Namespace namespace = (Namespace) getOwningElement(
				...
				com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.NAMESPACE, true);
			...
			EList<Type> ownedTypes = (EList<Type>) new UMLSwitch<Object>() {
				...
				@Override
				public Object caseClass(Class class_) {
					return class_.getNestedClassifier();
				}
				...
				@Override
				public Object caseInterface(Interface interface_) {
					return interface_.getNestedClassifier();
				}
		...
		protected Classifier createGenericType(EModelElement eModelElement,
			...
			Classifier genericType = eClassifier instanceof EDataType
				...
				: MdkernelFactory.eINSTANCE.createClass();
		...
		protected TemplateBinding createTemplateBinding(
			...
			TemplateBinding templateBinding = MdtemplatesFactory.eINSTANCE
		...
		public Object caseEAttribute(EAttribute eAttribute) {
			...
			if (eContainingClass != null) {
				Property property = MdkernelFactory.eINSTANCE.createProperty();
				...
				property.setReadOnly(!eAttribute.isChangeable());
		...
		public Object caseEClass(EClass eClass) {
			...
			if (ePackage != null) {
				Classifier classifier = eClass.isInterface()
					? (Classifier) MdinterfacesFactory.eINSTANCE.createInterface()
					: (ExtendedMetaData.INSTANCE.getSimpleFeature(eClass) == null
						? (Classifier) MdkernelFactory.eINSTANCE.createClass()
						: (Classifier) MdkernelFactory.eINSTANCE.createDataType());
				eModelElementToElementMap.put(eClass, classifier);

				Package package_ = (Package) doSwitch(ePackage);
				package_.getOwnedType().add(classifier);

				classifier.setName(eClass.getName());

				if (!eClass.isInterface()) {
					classifier.setAbstract(eClass.isAbstract());
				}
				...
				for (EGenericType eGenericSuperType : eClass
					...
					} else if (!ClassifierOperations.allParents(classifier).contains(generalType)) {
						classifier
		...
		public Object caseEDataType(EDataType eDataType) {
			...
			if (ePackage != null) {
				...
				Package package_ = (Package) doSwitch(ePackage);
				package_.getOwnedType().add(primitiveType);
				...
				if (baseType != null) {
					...
					if (!ClassifierOperations.allParents(primitiveType).contains(generalClassifier)) {
		...
		public Object caseEEnum(EEnum eEnum) {
			...
			if (ePackage != null) {
				Enumeration enumeration = MdkernelFactory.eINSTANCE
					.createEnumeration();
				eModelElementToElementMap.put(eEnum, enumeration);

				Package package_ = (Package) doSwitch(ePackage);
				package_.getOwnedType().add(enumeration);
		...
		public Object caseEEnumLiteral(EEnumLiteral eEnumLiteral) {
			...
			if (eEnum != null) {
				EnumerationLiteral enumerationLiteral = MdkernelFactory.eINSTANCE
				...
				if (value != eEnum.getELiterals().indexOf(eEnumLiteral)) {
					((LiteralInteger) enumerationLiteral.createSpecification(
						null, null, com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.LITERAL_INTEGER))
						.setValue(value);
				}
		...
		public Object caseEOperation(EOperation eOperation) {
			...
			if (eContainingClass != null) {
				Operation operation = MdkernelFactory.eINSTANCE.createOperation();
				...
				operation.setVisibility(VisibilityKindEnum.PUBLIC);
		...
		public Object caseEPackage(EPackage ePackage) {
			org.eclipse.uml2.uml.Package package_ = ePackage.getESuperPackage() == null
				? MdkernelFactory.eINSTANCE.createModel()
				: MdkernelFactory.eINSTANCE.createPackage();
			...
			if (!ePackages.contains(ePackage)) {
				...
				if (eSuperPackage != null) {
					((Package) doSwitch(eSuperPackage))
		...
		public Object caseEParameter(EParameter eParameter) {
			...
			if (eOperation != null) {
				Parameter parameter = MdkernelFactory.eINSTANCE.createParameter();
		...
		public Object caseEReference(EReference eReference) {
			...
			if (eContainingClass != null) {
				...
				property.setDerived(eReference.isDerived());
				property.setReadOnly(!eReference.isChangeable());
				...
				if (eOpposite == null) {
					Association association = (Association) ((org.eclipse.uml2.uml.Package) doSwitch(eContainingClass
						...
						com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.ASSOCIATION);
		...
		public Object caseETypedElement(ETypedElement eTypedElement) {
			...
			if (element != null) {
				...
				if (element instanceof MultiplicityElement) {
					...
					multiplicityElement.setOrdered(eTypedElement.isOrdered());
					multiplicityElement.setUnique(eTypedElement.isUnique());
				}
		...
		public Object caseETypeParameter(ETypeParameter eTypeParameter) {
			...
			if (eTypeParameters != null) {
				ClassifierTemplateParameter templateParameter = MdkernelFactory.eINSTANCE
				...
				org.eclipse.uml2.uml.Class parameterableElement = (org.eclipse.uml2.uml.Class) templateParameter
					.createOwnedParameteredElement(com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.CLASS);
			...
			if (eResource != null) {
				...
				if (resourceSet != null) {
					return load(resourceSet, URI
						...
						com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.PROFILE);
				}
			}
...
/*
					...
					if (contentKindEnumeration != null) {
						...
						switch (ExtendedMetaData.INSTANCE
							...
							case ExtendedMetaData.EMPTY_CONTENT :
								value = EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__EMPTY);
								break;
							case ExtendedMetaData.SIMPLE_CONTENT :
								value = EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__SIMPLE);
								break;
							case ExtendedMetaData.MIXED_CONTENT :
								value = EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__MIXED);
								break;
							case ExtendedMetaData.ELEMENT_ONLY_CONTENT :
								value = EnumerationOperations.getOwnedLiteral(contentKindEnumeration,ENUMERATION_LITERAL__ELEMENT_ONLY);
								break;
						}
					}
				} else if (propertyName == TAG_DEFINITION__XML_FEATURE_KIND) {
					...
					if (featureKindEnumeration != null) {
						...
						switch (ExtendedMetaData.INSTANCE
							...
							case ExtendedMetaData.SIMPLE_FEATURE :
								value = EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__SIMPLE);
								break;
							case ExtendedMetaData.ATTRIBUTE_FEATURE :
								value = EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ATTRIBUTE);
								break;
							case ExtendedMetaData.ATTRIBUTE_WILDCARD_FEATURE :
								value = EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ATTRIBUTE_WILDCARD);
								break;
							case ExtendedMetaData.ELEMENT_FEATURE :
								value = EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ELEMENT);
								break;
							case ExtendedMetaData.ELEMENT_WILDCARD_FEATURE :
								value = EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__ELEMENT_WILDCARD);
								break;
							case ExtendedMetaData.GROUP_FEATURE :
								value = EnumerationOperations.getOwnedLiteral(featureKindEnumeration,ENUMERATION_LITERAL__GROUP);
								break;
						}
					}
				} else if (propertyName == TAG_DEFINITION__XML_NAME) {
					...
					if (visibilityKindEnumeration != null) {
						...
						if (eModelElement instanceof EOperation) {
							...
							if (EcoreUtil
								...
								value = EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__NONE);
							}
						} else {
							eStructuralFeature = (EStructuralFeature) eModelElement;
							...
							if (EcoreUtil.isSuppressedVisibility(
								...
								if (EcoreUtil.isSuppressedVisibility(
									...
									if (EcoreUtil.isSuppressedVisibility(
										...
										value = EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__READ_ONLY);
									} else {
										value = EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__READ_ONLY_UNSETTABLE);
									}
								} else {
									...
									if (EcoreUtil.isSuppressedVisibility(
										...
										value = EnumerationOperations.getOwnedLiteral(visibilityKindEnumeration,ENUMERATION_LITERAL__READ_WRITE);
									}
								}
							}
						}
		...
		protected void processEcoreTaggedValues(Element element,
			...
			Stereotype eClassifierStereotype = new UMLSwitch<Stereotype>() {
				...
				@Override
				public Stereotype caseClass(Class class_) {
...
//								UMLPlugin.INSTANCE
					...
					OpaqueExpression expression = specification instanceof OpaqueExpression
						...
						: (OpaqueExpression) bodyCondition.createSpecification(
							null, null, com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.OPAQUE_EXPRESSION);
...
//		for (Namespace namespace : namedElement.allNamespaces()) {
		for (Namespace namespace : NamedElementOperations.allNamespaces(namedElement)) {
	...
	public static <NE extends NamedElement> Collection<NE> findNamedElements(
		...
		return findNamedElements(resourceSet, qualifiedName, ignoreCase,
			com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.NAMED_ELEMENT);
	}
	...
	public static <NE extends NamedElement> Collection<NE> findNamedElements(
		...
		if (!isEmpty(qualifiedName)
			&& com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.NAMED_ELEMENT.isSuperTypeOf(eClass)) {
	...
	protected static <NE extends NamedElement> Collection<NE> findNamedElements(
		...
		int index = qualifiedName.indexOf(NamedElementOperations.SEPARATOR);
		...
		if (index == -1) {
			...
			qualifiedName = qualifiedName.substring(index
				+ NamedElementOperations.SEPARATOR.length());

			for (Namespace namespace : EcoreUtil.<Namespace> getObjectsByType(
				eObjects, com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.NAMESPACE)) {

				if (ignoreCase
					? name.equalsIgnoreCase(namespace.getName())
					: name.equals(namespace.getName())) {

					findNamedElements(namespace.getMember(), qualifiedName,
...
/*
	protected static EPackage getEPackage(Package package_) {
		return EPackage.Registry.INSTANCE.getEPackage((String) getTaggedValue(
			package_, PROFILE__ECORE + NamedElementOperations.SEPARATOR
...
/*
	protected static NamedElement getNamedElement(ENamedElement definition,
		...
		if (definition instanceof EClassifier) {
			...
			Package package_ = (Package) getNamedElement(
			...
			Class class_ = (Class) getNamedElement(
			...
			if (class_ != null) {
				...
				for (Property ownedAttribute : class_.getOwnedAttribute()) {
			...
			return enumeration == null
				? null
				: EnumerationOperations.getOwnedLiteral(enumeration,definition.getName());
...
*/
	...
	public static EObject safeApplyStereotype(Element element,
		...
		if (stereotype != null) {
			...
			if (stereotypeApplication == null) {
				Package nearestPackage = ElementOperations.getNearestPackage(element);

				if (nearestPackage != null) {
					Profile profile = stereotype.getProfile();

//					if (!nearestPackage.getAllAppliedProfiles().contains(
					if (!PackageOperations.getAllAppliedProfiles(nearestPackage).contains(
						profile)) {

						EList<Package> allOwningPackages = NamedElementOperations.allOwningPackages(nearestPackage);
						int size = allOwningPackages.size();

//						(size > 0? allOwningPackages.get(size - 1): nearestPackage).applyProfile(profile);
	
						PackageOperations.applyProfile((size > 0
								? allOwningPackages.get(size - 1)
								: nearestPackage),profile);
					}

//					stereotypeApplication = element.isStereotypeRequired(stereotype)
					stereotypeApplication = ElementOperations.isStereotypeRequired(element,stereotype)
						? ElementOperations.getStereotypeApplication(element,stereotype)
//						: element.applyStereotype(stereotype);
						: ElementOperations.applyStereotype(element,stereotype);
				}
			}
...
//		return (Property) findEObject(stereotype.getAllAttributes(),
		return (Property) findEObject(StereotypeOperations.getAllAttributes(stereotype),
			new EObjectMatcher() {
...
//		Stereotype stereotype = element.getAppliedStereotype(qualifiedStereotypeName);
		Stereotype stereotype = ElementOperations.getAppliedStereotype(element,qualifiedStereotypeName);

		return stereotype == null
			? null
			: ElementOperations.getValue(element,stereotype, propertyName);
...
//			element.setValue(stereotype, propertyName, value);
			ElementOperations.setValue(element,stereotype, propertyName, value);
			return true;
		}
...
*/
	...
	protected static Element getOwningElement(Element element, EClass eClass,
			boolean resolve) {
		Element owningElement = element.getOwner();
		while(owningElement!=null){
			if(eClass.isInstance(owningElement))break;
			owningElement=owningElement.getOwner();
		}
		/*
		Element owner = element.getOwner();
		for (Element owner = element; 
			(
				(owningElement = (Element) owner.eGet(com.nomagic.uml2.ext.magicdraw.metadata.UMLPackage.Literals.ELEMENT__OWNER, resolve)) == null
	...
	protected static EList<Property> getOwnedAttributes(Type type) {
		return new UMLSwitch<EList<Property>>() {
			...
			public EList<Property> caseArtifact(Artifact artifact) {
				return new BasicEList<Property>(artifact.getOwnedAttribute());
			}

			@Override
			public EList<Property> caseDataType(DataType dataType) {
				return new BasicEList<Property>(dataType.getOwnedAttribute());
//				return dataType.getOwnedAttribute();
//				return DataTypeOperations.getOwnedAttribute(dataType);
			}

			@Override
			public EList<Property> caseInterface(Interface interface_) {
//				return interface_.getOwnedAttributes();
				return InterfaceOperations.getOwnedAttributes(interface_);
			}

			@Override
			public EList<Property> caseSignal(Signal signal) {
//				return signal.getOwnedAttributes();
				return SignalOperations.getOwnedAttributes(signal);
			}
...
//				return structuredClassifier.getOwnedAttributes();
				return StructuredClassifierOperations.getOwnedAttributes(structuredClassifier);
			}
	...
	protected static EList<Operation> getOwnedOperations(Type type) {
		return new UMLSwitch<EList<Operation>>() {
			...
			public EList<Operation> caseArtifact(Artifact artifact) {
				return new BasicEList<Operation>(artifact.getOwnedOperation());
			}

			@Override
			public EList<Operation> caseClass(Class class_) {
				return new BasicEList<Operation>(class_.getOwnedOperation());
			}

			@Override
			public EList<Operation> caseDataType(DataType dataType) {
				return new BasicEList<Operation>(dataType.getOwnedOperation());
			}

			@Override
			public EList<Operation> caseInterface(Interface interface_) {
				return new BasicEList<Operation>(interface_.getOwnedOperation());
			}
...
*/
	protected static EList<Feature> getRedefinedFeatures(Feature feature) {
		...
		EList<Feature> redefinedFeatures = (EList<Feature>) new UMLSwitch<Object>() {
			...
			@Override
			public Object caseOperation(Operation operation) {
				return operation.getRedefinedOperation();
			}
...
//		return redefinedFeature.isConsistentWith(redefiningFeature);
		return RedefinableElementOperations.isConsistentWith(redefinedFeature,redefiningFeature);
	}
	...
	protected static <F extends Feature> Collection<F> findValidRedefinitions(
		...
		if (redefinedFeature == null) {
			...
			for (Classifier general : ClassifierOperations.allParents(redefinitionContext)) {
	...
	private static <F extends Feature> F findValidRedefinition(
		...
		@SuppressWarnings("unchecked")
		F redefinedFeature = (F) findEObject(redefinitionContext.getFeature(),
...
//		for (Type subsettingContext : subsettingProperty.subsettingContext()) {
		for (Type subsettingContext : PropertyOperations.subsettingContext(subsettingProperty)) {

//			for (Type subsettedContext : subsettedProperty.subsettingContext()) {
			for (Type subsettedContext : PropertyOperations.subsettingContext(subsettedProperty)) {

				if (!TypeOperations.conformsTo(subsettingContext,subsettedContext)) {
					return false;
				}
			}
		}
...
//		for (Type subsettingContext : subsettingProperty.subsettingContext()) {
	...
	protected static Collection<Property> findValidSubsets(
		...
		Property subsettedProperty = (Property) findEObject(subsettingContext
			.getAttribute(), new EClassMatcher(subsettingProperty) {
		...
		if (subsettedProperty == null) {
			...
			for (Classifier general : subsettingContext.getGeneral()) {
				findValidSubsets(subsettedProperties, subsettingProperty, name,
					general);
			}
		} else {
...
*/
	...
	public static Collection<EPackage> convertToEcore(
			Package package_, Map<String, String> options) {
