...
public class ReferencesClassifierExpression extends NiemNameClassifierExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
  	if(Classifier.class.isInstance(object)){
    		...
    		return NIEMHelper.getReferencesReferenceModelClassifier(clientClassifier);
    	}
    	return null;
    }
