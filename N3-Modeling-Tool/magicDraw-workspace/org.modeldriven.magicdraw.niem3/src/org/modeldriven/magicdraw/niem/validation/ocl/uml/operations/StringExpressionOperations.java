...
public class StringExpressionOperations
	...
	protected static StringBuffer stringValue(
		...
		Collection<StringExpression> subExpressions = stringExpression
			.getSubExpression();
		...
		if (!subExpressions.isEmpty()) {
			...
			for (ValueSpecification operand : stringExpression.getOperand()) {
				stringValue.append(ValueSpecificationOperations.stringValue(operand));
