 ...
 *
 */
public class NDR7_14_AugmentationTypeOpeningPhrase extends OpeningPhraseRule
{
	@Override
	protected String getOpeningPhrase() {
		return "A data type that supplements ";
	}

	@Override
	protected boolean isComponentClass(Element namedElement) {
		return NIEMHelper.isAugmentationType(((Class)namedElement));
	}
