...
public class TopLevelPropertyExpression extends NiemNamePropertyExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
   	if(Property.class.isInstance(object)){
    		...
    		Property result= NameHelper.getSubsetPropertyHolderProperty(subsetProperty);
    		if(!subsetProperty.equals(result)){
    		return result;
    		}
    	}
    	return null;
