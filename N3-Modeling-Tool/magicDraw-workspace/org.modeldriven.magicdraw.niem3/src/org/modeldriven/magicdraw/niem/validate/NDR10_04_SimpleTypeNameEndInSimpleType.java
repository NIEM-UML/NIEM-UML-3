 ...
 *
 */
public class NDR10_04_SimpleTypeNameEndInSimpleType extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
...
//    	 String name=namedElement.getName();
    	 if(!PrimitiveType.class.isInstance(namedElement))return false;
    	 if(!NIEMHelper.isPimSimpleTypeDefinitionBase((PrimitiveType)namedElement))return false;
    	 String name=NameHelper.getNIEMName((Classifier)namedElement);
    	 
     	if((name==null)|| !name.endsWith(SIMPLETYPE_SUFFIX)){
     		return true;
    	}
    	 return false;
     }
    ...
    {
    	FixNameSuffixAction action = new FixNameSuffixAction((Classifier) element,SIMPLETYPE_SUFFIX);
