 ...
 *
 */
public class NDR7_14_DescriptionElementOpeningPhrase extends OpeningPhraseRule
{
	protected String getOpeningPhraseMatch() {
		return "(?s)"+"A description of .*";
	}
	@Override
...
//			&&isIndicator(namedElement.getName());
			&&isDescription(NameHelper.getNIEMName((Property)namedElement));
	}
