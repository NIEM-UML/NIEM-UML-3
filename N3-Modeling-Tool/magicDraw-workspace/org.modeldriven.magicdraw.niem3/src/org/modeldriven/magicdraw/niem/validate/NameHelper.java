...
//}				
	...
	/*
		...
		*/
		...
		public static Property setPropertyContentBasic(Property referenceProperty,Classifier subsetContext,Property subsetProperty,boolean isSubsetting){
			// check type....and any other references at this level.....
...
//		if(subsetPropertyHolderProperty==null)return false;
	...
	static public Property getSubsetPropertyHolderProperty(Property subsetProperty){
		...
		// implicit PropertyHolder
	    	...
	    	if((informationModel!=null)&&NIEMHelper.getNamespaceIsConformant(informationModel)){
	    		Property propertyHolderProperty=getNameToPropertyHolderPropertyMap(informationModel).get(getPropertyMapName(subsetProperty));
	...
	static public String getPropertyMapName(Property property){
		String name=getNIEMName(property);
		if(!NIEMHelper.isXSDElement(property))name="a."+name;
		return name;
	}
...
//					referenceNameToPropertyHolderPropertyMap.put(referencePropertyHolderProperty.getName(), referencePropertyHolderProperty);
					referenceNameToPropertyHolderPropertyMap.put(getPropertyMapName(referencePropertyHolderProperty), referencePropertyHolderProperty);
				}
			}
		}
...
//			if(classifier.getGeneral().isEmpty()||NIEMHelper.hasStereotype(classifier, NIEMHelper.getCommonStereotype(ValueRestrictionStereotypeName))){
	...
	static protected String getNIEMName(Property property,String suffix){
		String baseName=property.getName();
    	String result="";
    	if(baseName!=null) result=getBasePropertyName(baseName);
