...
public class AllReferencedInformationModelsPackagetExpression extends BaseValidationRule implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	...
    	if(Package.class.isInstance(object)){
    		Package informationModel=(Package)object;
    			NIEMHelper.findAllInformationModelsReferenced(informationModel,result,new HashSet<NamedElement>());
    		}
