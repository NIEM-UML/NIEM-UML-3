...
public class NiemTypedElementOfTypeExpression extends NiemNameClassifierExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	...
    	List<TypedElement> result=new Vector<TypedElement>();
    	if(Type.class.isInstance(object)){
    		Type clientClassifier=(Type)object;
			for(TypedElement typedElement:clientClassifier.get_typedElementOfType()){
				if(Property.class.isInstance(typedElement)&&!((Property)typedElement).isNavigable())continue;
