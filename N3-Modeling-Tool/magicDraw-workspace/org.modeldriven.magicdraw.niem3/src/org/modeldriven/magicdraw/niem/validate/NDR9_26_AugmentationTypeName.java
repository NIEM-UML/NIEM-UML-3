 ...
 *
 */
public class NDR9_26_AugmentationTypeName extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
...
//    	 String name=namedElement.getName();
    	 ...
    	 boolean isAugmentationType=NIEMHelper.isAugmentationType((Classifier)namedElement);
    	 boolean nameIsAugmentation=name==null?false:name.endsWith(AUGMENTATION_SUFFIX);
    ...
    {
    	FixNameSuffixAction action = new FixNameSuffixAction((Classifier) element,AUGMENTATION_SUFFIX);
