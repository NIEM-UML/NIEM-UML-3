 ...
 *
 */
public class AddEnumerationAction extends CommonDiagramAction {
	...
	public void actionPerformed(java.awt.event.ActionEvent e){
		Enumeration niemType=EnumerationAction.createEnumeration(this.getFirstSelected(),this.getDiagram(),stereotypeName);
