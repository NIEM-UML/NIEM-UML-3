 ...
 *
 */
public class NDR7_14_MetadataTypeOpeningPhrase extends OpeningPhraseRule
{
    protected boolean isOpeningPhraseValid(String body){
    	if(body==null)return false;
    	return body.matches(getOpeningPhraseMatch())
    	|| body.matches("(?s)"+"A data type for information that further qualifies .*");
    }
	
	@Override
	protected String getOpeningPhrase() {
		return "A data type for metadata about ";
	}
// "A data type for metadata about..." or "A data type for information that further qualifies..."
	@Override
	protected boolean isComponentClass(Element namedElement) {
		return NIEMHelper.isMetadataType(((Type)namedElement));
	}
