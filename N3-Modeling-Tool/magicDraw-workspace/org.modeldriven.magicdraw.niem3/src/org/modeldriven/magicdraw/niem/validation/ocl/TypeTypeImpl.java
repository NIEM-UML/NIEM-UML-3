...
//	private EList<Operation> operations;
	...
	public Classifier getReferredType() {
		...
		//log("TypeType.getReferredType "+referredType);
		//if(referredType!=null)log("TypeType.getReferredType "+referredType.getQualifiedName());
		return referredType;
	}
	...
	public Classifier basicGetReferredType() {
		//log("TypeType.basicGetReferredType "+referredType);
		//if(referredType!=null)log("TypeType.basicGetReferredType "+referredType.getQualifiedName());
		return referredType;
	}
	...
	public void setReferredType(Classifier newReferredType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				UMLPackage.TYPE_TYPE__REFERRED_TYPE, oldReferredType,
				referredType));
		if((oldReferredType!=null)&&(referredType!=null)){
			//log("TypeType.setReferredType "+referredType+", "+referredType.getQualifiedName()+", "+oldReferredType+", "+oldReferredType.getQualifiedName());
		}
		//log("TypeType.setReferredType "+referredType);
		//if(referredType!=null)log("TypeType.setReferredType "+referredType.getQualifiedName());
	}
