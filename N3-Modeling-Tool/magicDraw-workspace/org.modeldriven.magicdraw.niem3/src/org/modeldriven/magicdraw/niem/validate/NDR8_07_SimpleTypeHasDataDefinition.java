 ...
 *
 */
public class NDR8_07_SimpleTypeHasDataDefinition extends DocumentationRule
{
    protected boolean isElementInvalid(Element namedElement){
    	if(!(namedElement instanceof DataType))return false;
    	if(!NIEMHelper.isDataTypeSimpleType((DataType)namedElement))return false;
 		return isDataDefinitionElementInvalid(namedElement);
     }
