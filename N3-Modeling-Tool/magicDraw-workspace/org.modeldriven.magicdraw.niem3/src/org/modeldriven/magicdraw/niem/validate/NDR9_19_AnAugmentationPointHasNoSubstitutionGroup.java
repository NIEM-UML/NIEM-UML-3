 ...
 *
 */
public class NDR9_19_AnAugmentationPointHasNoSubstitutionGroup extends NameValidationRule 
	//implements Expression
{
	public NDR9_19_AnAugmentationPointHasNoSubstitutionGroup(){}
    /**
     * {@inheritDoc}
     */
    @Override
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
    	...
    	return subsetProperty.getSubsettedProperty()!=null;
	 	}
/* no fix
    @Override
