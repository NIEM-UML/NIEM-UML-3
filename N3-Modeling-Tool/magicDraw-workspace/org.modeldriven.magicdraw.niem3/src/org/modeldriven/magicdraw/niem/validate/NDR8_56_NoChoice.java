 ...
 *
 */
public class NDR8_56_NoChoice extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
...
//    	return(subsetLiteralName.equals(name)||referenceLiteralName.equals(name));
    	return referenceLiteralName.equals(name);
	 	}
    ...
    {
    	FixChoiceAction action = new FixChoiceAction((NamedElement) element);
        return new Annotation(element, constraint, Collections.singletonList(action));
    }
    ///////////////////////////////////////////////
    static public class FixChoiceAction extends FixNameAction implements AnnotationAction
    {

        public FixChoiceAction(NamedElement property)
        {
            super(property);
