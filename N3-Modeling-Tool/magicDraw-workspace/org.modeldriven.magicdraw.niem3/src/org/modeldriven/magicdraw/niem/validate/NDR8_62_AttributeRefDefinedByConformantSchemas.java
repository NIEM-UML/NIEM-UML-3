 ...
 *
 */
public class NDR8_62_AttributeRefDefinedByConformantSchemas extends NameValidationRule 
	//implements Expression
{
	public NDR8_62_AttributeRefDefinedByConformantSchemas(){}
    /**
     * {@inheritDoc}
     */
    @Override
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
    	...
    	/*
    	    	...
    	    	return !NIEMHelper.isInImportedAsConformantNamespace(type);
    	    	*/
        }
}
