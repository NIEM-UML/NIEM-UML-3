...
public class SubstitutionGroupAffiliationPropertyExpression extends NiemNamePropertyExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
     	if(Property.class.isInstance(object)){
    		...
    		for(Property subGroup:clientProperty.getSubsettedProperty()){
    			return subGroup;
    		}
    		Property holderProperty= NameHelper.getSubsetPropertyHolderProperty(clientProperty);
    		if(holderProperty!=null)
    		for(Property subGroup:holderProperty.getSubsettedProperty()){
    			return subGroup;
    		}
    	}
    	return null;
