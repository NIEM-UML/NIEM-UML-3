 ...
 *
 */
public class NDR10_03_BaseTypeDefinitionDefinedByConformantSchema extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
	   	 ...
	   	 if(Classifier.class.isInstance(namedElement)){
	   		...
	   		if(general!=null){
			 if(!(NIEMHelper.isInImportedAsConformantNamespace(general)))return true;
	   		}
	   	 }
	   	 return false;
	 	}
