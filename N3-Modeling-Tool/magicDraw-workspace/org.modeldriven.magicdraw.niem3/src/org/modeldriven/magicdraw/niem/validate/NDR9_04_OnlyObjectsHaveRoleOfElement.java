 ...
 *
 */
public class NDR9_04_OnlyObjectsHaveRoleOfElement extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
	...
	public Map<java.lang.Class<? extends Element>, Collection<SmartListenerConfig>> getListenerConfigurations()
    {
     ...
     protected boolean isNameInvalid(NamedElement namedElement){
     	...
     	Classifier type=property.getClassifier();
     	if(type==null)return true;
     	if(!(type instanceof Classifier))return true;
     	if(NIEMHelper.isPropertyHolder(type))return false;
     ...
     protected boolean isElementInvalid(Element namedElement){
      	...
      	Classifier type=property.getSpecific();
 		 if(!NIEMHelper.isObjectType((Classifier)type))return true;
     	 return false;
