...
public class NiemContainerPropertyExpression extends NiemNamePropertyExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	if(Property.class.isInstance(object)){
    		...
    		Element owner=subsetProperty.getOwner();
    		if(NIEMHelper.isPropertyHolder(owner))return NIEMHelper.getNearestInformationModel(subsetProperty);
    		if(Namespace.class.isInstance(owner))return (Namespace)owner;
    	}
    	return null;
    }
