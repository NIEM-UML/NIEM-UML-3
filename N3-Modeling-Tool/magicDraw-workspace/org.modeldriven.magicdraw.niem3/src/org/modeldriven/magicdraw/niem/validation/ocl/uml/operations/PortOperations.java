...
public class PortOperations
	...
	public static boolean validatePortAggregation(Port port,
		...
		if (port.getAggregation() != AggregationKindEnum.COMPOSITE) {

			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING,
					UMLValidator.DIAGNOSTIC_SOURCE,
					UMLValidator.PORT__PORT_AGGREGATION, NIEMResourceLoader.INSTANCE
	...
	public static boolean validateDefaultValue(Port port,
		...
		if (port.getType() instanceof Interface
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING,
					UMLValidator.DIAGNOSTIC_SOURCE,
					UMLValidator.PORT__DEFAULT_VALUE, NIEMResourceLoader.INSTANCE
