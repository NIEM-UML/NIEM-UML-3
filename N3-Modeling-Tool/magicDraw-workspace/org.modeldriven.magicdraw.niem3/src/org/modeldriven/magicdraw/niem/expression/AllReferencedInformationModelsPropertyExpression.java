...
public class AllReferencedInformationModelsPropertyExpression extends NiemNamePropertyExpression implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	...
    	if(Property.class.isInstance(object)){
    			NIEMHelper.findAllInformationModelsReferencedByProperty((Property)object,result,new HashSet<NamedElement>());
    		}
