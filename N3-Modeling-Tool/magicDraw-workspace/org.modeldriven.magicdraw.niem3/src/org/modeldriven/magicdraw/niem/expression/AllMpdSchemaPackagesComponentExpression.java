...
public class AllMpdSchemaPackagesComponentExpression extends MpdSchemaPackagesComponentExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	if(Component.class.isInstance(object)){
    		...
    		return NIEMHelper.getAllModelPackageDescriptionInformationModels(mpd);
    	}
