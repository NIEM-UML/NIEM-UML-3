 ...
 *
 */
public class NDR9_02_ObjectTypeDerivedFromObjectType extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
	...
	public Map<java.lang.Class<? extends Element>, Collection<SmartListenerConfig>> getListenerConfigurations()
    {
     ...
     protected boolean isNameInvalid(NamedElement namedElement){
		...
		if(general==null)return false;
		 if(!NIEMHelper.isObjectType((Classifier)namedElement))return false;
		 // could be simple type
		 if(!NIEMHelper.isComplexType(general))return false;
		 if(!NIEMHelper.isObjectType(general))return true;
    	 return false;
     }
