...
public class ReferencesAggregationPropertyExpression extends NiemNamePropertyExpression
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
 	if(Property.class.isInstance(object)){
    		...
    		Property referenceProperty= NIEMHelper.getReferenceProperty(clientProperty);
    		if(referenceProperty!=null){
    			AggregationKind aggregation=referenceProperty.getAggregation();
    			if(aggregation!=null)return ((AggregationKindEnum)aggregation).getName();
    		}
    	}
    	return null;
    }
