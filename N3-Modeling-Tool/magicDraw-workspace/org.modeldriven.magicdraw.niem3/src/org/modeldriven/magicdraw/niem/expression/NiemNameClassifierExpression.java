...
public class NiemNameClassifierExpression extends BaseValidationRule implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
 	if(Classifier.class.isInstance(object)){
    		return NameHelper.getNIEMName((Classifier)object);
    	}
    	return "";
    }
  ...
  public Map<java.lang.Class<? extends Element>, Collection<SmartListenerConfig>> getListenerConfigurations()
  {
    ...
    addClassifierAppliedStereotypeConfiguration(configs);
    /*
