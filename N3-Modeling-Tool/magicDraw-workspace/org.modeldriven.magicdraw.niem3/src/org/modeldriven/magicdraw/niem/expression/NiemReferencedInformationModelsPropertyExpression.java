...
public class NiemReferencedInformationModelsPropertyExpression extends NiemNamePropertyExpression implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	...
    	if(Property.class.isInstance(object)){
    			NIEMHelper.findInformationModelsReferencedByProperty((Property)object,result);
    		}
