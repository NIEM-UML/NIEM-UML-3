 ...
 *
 */
public class WildcardDecompositionDialogHelper extends SubstitutionGroupDecompositionDialogHelper{
	public static WildcardDecompositionDialogHelper INSTANCE=new WildcardDecompositionDialogHelper();
	
	// do we need a version of this and substitutionGroup for restriction?
	public  void wildcardDecompositionAction(MDMenuAction category,final Property selectedProperty,String niemGroupName){
		decompositionAction(category,selectedProperty,niemGroupName,"wildcardDecomposition","Wildcard Decomposition",WILDCARD_DECOMPOSITION_ACTION_TOOLTIP);
	}
	 ...
	 protected String getDialogDescriptionTitle(){	 
		 return WILDCARD_DECOMPOSITION_DIALOG_DESCRIPTION_TITLE;
	}
	 protected String getDialogDescription(){	 
		 return WILDCARD_DECOMPOSITION_DIALOG_DESCRIPTION;
	}
	 protected String getDialogHelpId(){	 
		 return "niem_uml_modeling_workingwithmodelelements_selectinganelement_wildcarddecomposition";
	}	 
