...
public class NiemReferencedInformationModelsClassifierExpression extends NiemNameClassifierExpression implements Expression, SmartListenerConfigurationProvider
{
    /**
  ...
  public Object getValue(/*@CheckForNull*/ RefObject object)
    {
    	...
    	if(Classifier.class.isInstance(object)){
    			NIEMHelper.findInformationModelsReferencedByType((Classifier)object,result);
    		}
		Set<String> stringResult=new HashSet<String>();
    	for(Package p:result){
    		stringResult.add(p.getQualifiedName());
    	}
    	return stringResult;
    }
