 ...
 *
 */
public class NDR8_63_OnlyKnownAttributeGroups extends NameValidationRule
{
    /**
     * {@inheritDoc}
     */
    ...
    protected boolean isNameInvalid(NamedElement namedElement){
	 	if(!Classifier.class.isInstance(namedElement)){return false;}
	   	 ...
	   	 if(NameHelper.isAttributeGroupDefinition(NIEMHelper.getNearestPackage(namedElement))){
 	    	Package informationModel=NIEMHelper.getNearestInformationModel(namedElement);
	   		 if(informationModel!=null){
	   			 ...
	   			 if(targetNamespace!=null){
	   				 return !targetNamespace.equals("urn:us:gov:ic:ism")&&!targetNamespace.equals("urn:us:gov:ic:ntk");
	   			 }
	   		 }
	   	 }
	   	 return false;
