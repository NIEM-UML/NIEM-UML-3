 ...
 *
 */
public class NIEMDirectedAssociationAction extends DrawPathActionCommon {

	public NIEMDirectedAssociationAction(String name) {
		super(name);
		// TODO Auto-generated constructor stub
		this.setLargeIcon(getUmlIcon("directedassociation"));
