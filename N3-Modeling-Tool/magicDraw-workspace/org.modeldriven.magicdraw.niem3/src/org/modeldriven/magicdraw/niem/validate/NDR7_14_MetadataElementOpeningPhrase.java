 ...
 *
 */
public class NDR7_14_MetadataElementOpeningPhrase extends OpeningPhraseRule
{
    protected boolean isOpeningPhraseValid(String body){
    	if(body==null)return false;
    	return body.matches(getOpeningPhraseMatch())
    	|| body.matches("(?s)"+"Information that further qualifies .*");
    }
	...
	//Either "Metadata about..." or "Information that further qualifies..."
	@Override
	protected boolean isComponentClass(Element namedElement) {
		return NIEMHelper.isXSDElement((Property)namedElement)
			...
			&&NIEMHelper.isMetadataType((Classifier)((Property)namedElement).getType());
	}
