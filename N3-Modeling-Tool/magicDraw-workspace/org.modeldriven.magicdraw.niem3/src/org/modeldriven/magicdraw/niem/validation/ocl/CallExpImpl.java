...
public abstract class CallExpImpl
	...
	public OCLExpression<Classifier> getSource() {
		//if((source!=null)&&(source.getType()!=null))log("CallExp.getSource "+source+"("+source.getClass().getName()+"), "+source.getType().getQualifiedName());
		//else log("CallExp.getSource "+source);
		return source;
	}
	...
	public NotificationChain basicSetSource(
		...
		/*
			log(getClass().getName()+".basicSetSource source="+(source==null?"null":
	...
	public void setType(Type type){
		super.setType(type);
		//log("CallExp.setType "+type+", "+(type==null?"null":type.getQualifiedName()));
	}
	public Classifier getType(){
		Classifier type=super.getType();
		//log("CallExp.getType "+type+", "+(type==null?"null":type.getQualifiedName()));
		return type;
	}
	/**
	 * <!-- begin-user-doc -->
...
//		if((source!=null)&&(source.getType()!=null))log("CallExp.setSource "+source+"("+source.getClass().getName()+"), "+source.getType().getQualifiedName());
	}
