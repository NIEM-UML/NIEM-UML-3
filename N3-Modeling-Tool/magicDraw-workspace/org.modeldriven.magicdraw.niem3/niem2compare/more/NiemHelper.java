...
//		return getDrawFrameFragment(file,diagram.getName(),getUriFragment(diagram));
		return "";
			...
			log("ERROR: create diagram image failed :"+diagram+", "+t);
			return "";
		}
	}
...
*/
	...
	*/
	...
	//////////////////////////////////////
	public CatalogType getMpdCatalog(Element context,String filePath){
...
//		Resource resource=context.eResource().getResourceSet().getResource(uri,true);
	    ...
	    mpdcatResourceFactoryImpl rf=new gov.niem.reference.niem.resource.mpd.catalog._1.mpdcat.util.mpdcatResourceFactoryImpl();
