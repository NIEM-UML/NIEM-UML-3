 ...
 * <ul>
 *   <li>{@link gov.niem.niem.structures._2.impl.AugmentationTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.niem.structures._2.impl.AugmentationTypeImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AugmentationTypeImpl extends MinimalEObjectImpl.Container implements AugmentationType {
	...
	protected EClass eStaticClass() {
		return _2Package.Literals.AUGMENTATION_TYPE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.AUGMENTATION_TYPE__ID, oldId, id));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.AUGMENTATION_TYPE__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2Package.AUGMENTATION_TYPE__ID:
				return getId();
			case _2Package.AUGMENTATION_TYPE__METADATA:
				return getMetadata();
		}
