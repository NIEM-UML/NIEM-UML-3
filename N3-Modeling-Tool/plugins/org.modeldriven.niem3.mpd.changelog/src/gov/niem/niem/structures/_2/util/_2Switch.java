/**
 */
package gov.niem.niem.structures._2.util;
...
public class _2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case _2Package.AUGMENTATION_TYPE: {
				AugmentationType augmentationType = (AugmentationType)theEObject;
				T result = caseAugmentationType(augmentationType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case _2Package.COMPLEX_OBJECT_TYPE: {
				ComplexObjectType complexObjectType = (ComplexObjectType)theEObject;
				T result = caseComplexObjectType(complexObjectType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Augmentation Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Augmentation Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAugmentationType(AugmentationType object) {
		return null;
	}
