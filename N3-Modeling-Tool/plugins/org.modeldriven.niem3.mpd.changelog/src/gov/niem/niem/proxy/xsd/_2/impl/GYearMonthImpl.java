 ...
 * <ul>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.GYearMonthImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.GYearMonthImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.GYearMonthImpl#getLinkMetadata <em>Link Metadata</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.GYearMonthImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GYearMonthImpl extends MinimalEObjectImpl.Container implements GYearMonth {
	...
	protected EClass eStaticClass() {
		return _2Package.Literals.GYEAR_MONTH;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.GYEAR_MONTH__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.GYEAR_MONTH__ID, oldId, id));
	}
	...
	public void setLinkMetadata(List<String> newLinkMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.GYEAR_MONTH__LINK_METADATA, oldLinkMetadata, linkMetadata));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.GYEAR_MONTH__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2Package.GYEAR_MONTH__VALUE:
				return getValue();
			case _2Package.GYEAR_MONTH__ID:
				return getId();
			case _2Package.GYEAR_MONTH__LINK_METADATA:
				return getLinkMetadata();
			case _2Package.GYEAR_MONTH__METADATA:
				return getMetadata();
		}
