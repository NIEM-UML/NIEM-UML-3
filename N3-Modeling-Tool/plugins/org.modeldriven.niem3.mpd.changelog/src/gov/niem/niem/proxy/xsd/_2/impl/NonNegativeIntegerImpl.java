 ...
 * <ul>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.NonNegativeIntegerImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.NonNegativeIntegerImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.NonNegativeIntegerImpl#getLinkMetadata <em>Link Metadata</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.NonNegativeIntegerImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NonNegativeIntegerImpl extends MinimalEObjectImpl.Container implements NonNegativeInteger {
	...
	protected EClass eStaticClass() {
		return _2Package.Literals.NON_NEGATIVE_INTEGER;
	}
	...
	public void setValue(BigInteger newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.NON_NEGATIVE_INTEGER__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.NON_NEGATIVE_INTEGER__ID, oldId, id));
	}
	...
	public void setLinkMetadata(List<String> newLinkMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.NON_NEGATIVE_INTEGER__LINK_METADATA, oldLinkMetadata, linkMetadata));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.NON_NEGATIVE_INTEGER__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2Package.NON_NEGATIVE_INTEGER__VALUE:
				return getValue();
			case _2Package.NON_NEGATIVE_INTEGER__ID:
				return getId();
			case _2Package.NON_NEGATIVE_INTEGER__LINK_METADATA:
				return getLinkMetadata();
			case _2Package.NON_NEGATIVE_INTEGER__METADATA:
				return getMetadata();
		}
