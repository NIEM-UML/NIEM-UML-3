 ...
 * <ul>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.HexBinaryImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.HexBinaryImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.HexBinaryImpl#getLinkMetadata <em>Link Metadata</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.HexBinaryImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HexBinaryImpl extends MinimalEObjectImpl.Container implements HexBinary {
	...
	protected EClass eStaticClass() {
		return _2Package.Literals.HEX_BINARY;
	}
	...
	public void setValue(byte[] newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.HEX_BINARY__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.HEX_BINARY__ID, oldId, id));
	}
	...
	public void setLinkMetadata(List<String> newLinkMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.HEX_BINARY__LINK_METADATA, oldLinkMetadata, linkMetadata));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.HEX_BINARY__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2Package.HEX_BINARY__VALUE:
				return getValue();
			case _2Package.HEX_BINARY__ID:
				return getId();
			case _2Package.HEX_BINARY__LINK_METADATA:
				return getLinkMetadata();
			case _2Package.HEX_BINARY__METADATA:
				return getMetadata();
		}
