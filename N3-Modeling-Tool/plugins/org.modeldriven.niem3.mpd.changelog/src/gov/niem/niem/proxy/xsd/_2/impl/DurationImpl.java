 ...
 * <ul>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DurationImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DurationImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DurationImpl#getLinkMetadata <em>Link Metadata</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DurationImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationImpl extends MinimalEObjectImpl.Container implements Duration {
	...
	protected EClass eStaticClass() {
		return _2Package.Literals.DURATION;
	}
	...
	public void setValue(javax.xml.datatype.Duration newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DURATION__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DURATION__ID, oldId, id));
	}
	...
	public void setLinkMetadata(List<String> newLinkMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DURATION__LINK_METADATA, oldLinkMetadata, linkMetadata));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DURATION__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2Package.DURATION__VALUE:
				return getValue();
			case _2Package.DURATION__ID:
				return getId();
			case _2Package.DURATION__LINK_METADATA:
				return getLinkMetadata();
			case _2Package.DURATION__METADATA:
				return getMetadata();
		}
