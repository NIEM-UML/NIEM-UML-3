 ...
 * <ul>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.StringImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.StringImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.StringImpl#getLinkMetadata <em>Link Metadata</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.StringImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StringImpl extends MinimalEObjectImpl.Container implements gov.niem.niem.proxy.xsd._2.String {
	/**
	...
	protected EClass eStaticClass() {
		return _2Package.Literals.STRING;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.STRING__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.STRING__ID, oldId, id));
	}
	...
	public void setLinkMetadata(List<String> newLinkMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.STRING__LINK_METADATA, oldLinkMetadata, linkMetadata));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.STRING__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2Package.STRING__VALUE:
				return getValue();
			case _2Package.STRING__ID:
				return getId();
			case _2Package.STRING__LINK_METADATA:
				return getLinkMetadata();
			case _2Package.STRING__METADATA:
				return getMetadata();
		}
