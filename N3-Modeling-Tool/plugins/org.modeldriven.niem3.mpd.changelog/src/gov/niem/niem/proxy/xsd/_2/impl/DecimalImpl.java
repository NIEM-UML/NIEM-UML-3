 ...
 * <ul>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DecimalImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DecimalImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DecimalImpl#getLinkMetadata <em>Link Metadata</em>}</li>
 *   <li>{@link gov.niem.niem.proxy.xsd._2.impl.DecimalImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecimalImpl extends MinimalEObjectImpl.Container implements Decimal {
	...
	protected EClass eStaticClass() {
		return _2Package.Literals.DECIMAL;
	}
	...
	public void setValue(BigDecimal newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DECIMAL__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DECIMAL__ID, oldId, id));
	}
	...
	public void setLinkMetadata(List<String> newLinkMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DECIMAL__LINK_METADATA, oldLinkMetadata, linkMetadata));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2Package.DECIMAL__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2Package.DECIMAL__VALUE:
				return getValue();
			case _2Package.DECIMAL__ID:
				return getId();
			case _2Package.DECIMAL__LINK_METADATA:
				return getLinkMetadata();
			case _2Package.DECIMAL__METADATA:
				return getMetadata();
		}
