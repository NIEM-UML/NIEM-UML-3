 ...
 * <ul>
 *   <li>{@link org.oclc.purl.dsdl.schematron.impl.IncludeTypeImpl#getHref <em>Href</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IncludeTypeImpl extends EObjectImpl implements IncludeType {
	...
	protected EClass eStaticClass() {
		return SchematronPackage.Literals.INCLUDE_TYPE;
	}
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchematronPackage.INCLUDE_TYPE__HREF, oldHref, href));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchematronPackage.INCLUDE_TYPE__HREF:
				return getHref();
		}
