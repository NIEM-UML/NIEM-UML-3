...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Conformance Target Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link gov.niem.reference.niem.resource.mpd.catalog._3._0.impl.ConformanceTargetTypeImpl#getDescriptionText <em>Description Text</em>}</li>
 *   <li>{@link gov.niem.reference.niem.resource.mpd.catalog._3._0.impl.ConformanceTargetTypeImpl#getConformanceTargetURI <em>Conformance Target URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConformanceTargetTypeImpl extends ObjectTypeImpl implements ConformanceTargetType {
	/**
	 ...
	 * @generated
	 */
	protected ConformanceTargetTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.CONFORMANCE_TARGET_TYPE;
	}
	...
	public NotificationChain basicSetDescriptionText(TextType newDescriptionText, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.CONFORMANCE_TARGET_TYPE__DESCRIPTION_TEXT, oldDescriptionText, newDescriptionText, !oldDescriptionTextESet);
	...
	public void setDescriptionText(TextType newDescriptionText) {
		if (newDescriptionText != descriptionText) {
			...
			if (descriptionText != null)
				msgs = ((InternalEObject)descriptionText).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.CONFORMANCE_TARGET_TYPE__DESCRIPTION_TEXT, null, msgs);
			if (newDescriptionText != null)
				msgs = ((InternalEObject)newDescriptionText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.CONFORMANCE_TARGET_TYPE__DESCRIPTION_TEXT, null, msgs);
			...
			descriptionTextESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, _0Package.CONFORMANCE_TARGET_TYPE__DESCRIPTION_TEXT, newDescriptionText, newDescriptionText, !oldDescriptionTextESet));
		}
	}
	...
	public NotificationChain basicUnsetDescriptionText(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, _0Package.CONFORMANCE_TARGET_TYPE__DESCRIPTION_TEXT, oldDescriptionText, null, oldDescriptionTextESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetDescriptionText() {
		if (descriptionText != null) {
			...
			descriptionTextESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.CONFORMANCE_TARGET_TYPE__DESCRIPTION_TEXT, null, null, oldDescriptionTextESet));
		}
	}
	...
	public void setConformanceTargetURI(String newConformanceTargetURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.CONFORMANCE_TARGET_TYPE__CONFORMANCE_TARGET_URI, oldConformanceTargetURI, conformanceTargetURI));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.CONFORMANCE_TARGET_TYPE__DESCRIPTION_TEXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _0Package.CONFORMANCE_TARGET_TYPE__CONFORMANCE_TARGET_URI:
