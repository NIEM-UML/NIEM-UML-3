 ...
 * <ul>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DurationImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DurationImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DurationImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DurationImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DurationImpl#getRelationshipMetadata <em>Relationship Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DurationImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationImpl extends MinimalEObjectImpl.Container implements Duration {
	 ...
	 * @ordered
	 */
	protected static final javax.xml.datatype.Duration VALUE_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected javax.xml.datatype.Duration value = VALUE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.DURATION;
	}
	 ...
	 * @generated
	 */
	public void setValue(javax.xml.datatype.Duration newValue) {
		javax.xml.datatype.Duration oldValue = value;
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DURATION__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DURATION__ID, oldId, id));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DURATION__METADATA, oldMetadata, metadata));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DURATION__REF, oldRef, ref));
	}
	...
	public void setRelationshipMetadata(List<String> newRelationshipMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DURATION__RELATIONSHIP_METADATA, oldRelationshipMetadata, relationshipMetadata));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.DURATION__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.DURATION__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.DURATION__VALUE:
				return getValue();
			case _0Package.DURATION__ID:
				return getId();
			case _0Package.DURATION__METADATA:
				return getMetadata();
			case _0Package.DURATION__REF:
				return getRef();
			case _0Package.DURATION__RELATIONSHIP_METADATA:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case _0Package.DURATION__VALUE:
				setValue((javax.xml.datatype.Duration)newValue);
				return;
			case _0Package.DURATION__ID:
