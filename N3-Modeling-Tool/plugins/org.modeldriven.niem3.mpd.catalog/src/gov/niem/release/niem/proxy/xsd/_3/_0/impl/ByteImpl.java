 ...
 * <ul>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.ByteImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.ByteImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.ByteImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.ByteImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.ByteImpl#getRelationshipMetadata <em>Relationship Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.ByteImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ByteImpl extends MinimalEObjectImpl.Container implements gov.niem.release.niem.proxy.xsd._3._0.Byte {
	/**
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.BYTE;
	}
	...
	public void setValue(byte newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BYTE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.BYTE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BYTE__ID, oldId, id));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BYTE__METADATA, oldMetadata, metadata));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BYTE__REF, oldRef, ref));
	}
	...
	public void setRelationshipMetadata(List<String> newRelationshipMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BYTE__RELATIONSHIP_METADATA, oldRelationshipMetadata, relationshipMetadata));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.BYTE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.BYTE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.BYTE__VALUE:
				return getValue();
			case _0Package.BYTE__ID:
				return getId();
			case _0Package.BYTE__METADATA:
				return getMetadata();
			case _0Package.BYTE__REF:
				return getRef();
			case _0Package.BYTE__RELATIONSHIP_METADATA:
