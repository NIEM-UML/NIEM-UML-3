...
public class _0AdapterFactory extends AdapterFactoryImpl {
	...
	protected _0Switch<Adapter> modelSwitch =
		new _0Switch<Adapter>() {
			...
			@Override
			public Adapter caseAugmentationType(AugmentationType object) {
				return createAugmentationTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link gov.niem.release.niem.structures._3._0.AugmentationType <em>Augmentation Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAugmentationTypeAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link gov.niem.release.niem.structures._3._0.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
