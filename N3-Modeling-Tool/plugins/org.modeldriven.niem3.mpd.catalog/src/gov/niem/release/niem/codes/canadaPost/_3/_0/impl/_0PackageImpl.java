...
import gov.niem.release.niem.codes.canadaPost._3._0.CanadianProvinceCodeSimpleType;
import gov.niem.release.niem.codes.canadaPost._3._0.CanadianProvinceCodeType;
import gov.niem.release.niem.codes.canadaPost._3._0._0Factory;
import gov.niem.release.niem.codes.canadaPost._3._0._0Package;
...
public class _0PackageImpl extends EPackageImpl implements _0Package {
	 ...
	 * @generated
	 */
	private EClass canadianProvinceCodeTypeEClass = null;
	 ...
	 * @generated
	 */
	private EEnum canadianProvinceCodeSimpleTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType canadianProvinceCodeSimpleTypeObjectEDataType = null;
	 ...
	 * @see gov.niem.release.niem.codes.canadaPost._3._0._0Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getCanadianProvinceCodeType() {
		return canadianProvinceCodeTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanadianProvinceCodeType_Value() {
		return (EAttribute)canadianProvinceCodeTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanadianProvinceCodeType_Id() {
		return (EAttribute)canadianProvinceCodeTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanadianProvinceCodeType_Metadata() {
		return (EAttribute)canadianProvinceCodeTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanadianProvinceCodeType_Ref() {
		return (EAttribute)canadianProvinceCodeTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanadianProvinceCodeType_RelationshipMetadata() {
		return (EAttribute)canadianProvinceCodeTypeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanadianProvinceCodeType_AnyAttribute() {
		return (EAttribute)canadianProvinceCodeTypeEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EEnum getCanadianProvinceCodeSimpleType() {
		return canadianProvinceCodeSimpleTypeEEnum;
	}
	 ...
	 * @generated
	 */
	public EDataType getCanadianProvinceCodeSimpleTypeObject() {
		return canadianProvinceCodeSimpleTypeObjectEDataType;
	}
	...
	public void createPackageContents() {
		...
		canadianProvinceCodeTypeEClass = createEClass(CANADIAN_PROVINCE_CODE_TYPE);
		createEAttribute(canadianProvinceCodeTypeEClass, CANADIAN_PROVINCE_CODE_TYPE__VALUE);
		createEAttribute(canadianProvinceCodeTypeEClass, CANADIAN_PROVINCE_CODE_TYPE__ID);
		createEAttribute(canadianProvinceCodeTypeEClass, CANADIAN_PROVINCE_CODE_TYPE__METADATA);
		createEAttribute(canadianProvinceCodeTypeEClass, CANADIAN_PROVINCE_CODE_TYPE__REF);
		createEAttribute(canadianProvinceCodeTypeEClass, CANADIAN_PROVINCE_CODE_TYPE__RELATIONSHIP_METADATA);
		createEAttribute(canadianProvinceCodeTypeEClass, CANADIAN_PROVINCE_CODE_TYPE__ANY_ATTRIBUTE);

		// Create enums
		canadianProvinceCodeSimpleTypeEEnum = createEEnum(CANADIAN_PROVINCE_CODE_SIMPLE_TYPE);

		// Create data types
		canadianProvinceCodeSimpleTypeObjectEDataType = createEDataType(CANADIAN_PROVINCE_CODE_SIMPLE_TYPE_OBJECT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(canadianProvinceCodeTypeEClass, CanadianProvinceCodeType.class, "CanadianProvinceCodeType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCanadianProvinceCodeType_Value(), this.getCanadianProvinceCodeSimpleType(), "value", null, 0, 1, CanadianProvinceCodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanadianProvinceCodeType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, CanadianProvinceCodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanadianProvinceCodeType_Metadata(), theXMLTypePackage.getIDREFS(), "metadata", null, 0, 1, CanadianProvinceCodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanadianProvinceCodeType_Ref(), theXMLTypePackage.getIDREF(), "ref", null, 0, 1, CanadianProvinceCodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanadianProvinceCodeType_RelationshipMetadata(), theXMLTypePackage.getIDREFS(), "relationshipMetadata", null, 0, 1, CanadianProvinceCodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanadianProvinceCodeType_AnyAttribute(), ecorePackage.getEFeatureMapEntry(), "anyAttribute", null, 0, -1, CanadianProvinceCodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.class, "CanadianProvinceCodeSimpleType");
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.AB);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.BC);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.MB);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.NB);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.NL);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.NS);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.NT);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.NU);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.ON);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.PE);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.QC);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.SK);
		addEEnumLiteral(canadianProvinceCodeSimpleTypeEEnum, CanadianProvinceCodeSimpleType.YT);

		// Initialize data types
		initEDataType(canadianProvinceCodeSimpleTypeObjectEDataType, CanadianProvinceCodeSimpleType.class, "CanadianProvinceCodeSimpleTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (canadianProvinceCodeSimpleTypeEEnum, 
		   source, 
		   new String[] {
			 "name", "CanadianProvinceCodeSimpleType"
		   });															
		addAnnotation
		  (canadianProvinceCodeSimpleTypeObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "CanadianProvinceCodeSimpleType:Object",
			 "baseType", "CanadianProvinceCodeSimpleType"
		   });			
		addAnnotation
		  (canadianProvinceCodeTypeEClass, 
		   source, 
		   new String[] {
			 "name", "CanadianProvinceCodeType",
			 "kind", "simple"
		   });		
		addAnnotation
		  (getCanadianProvinceCodeType_Value(), 
		   source, 
		   new String[] {
			 "name", ":0",
			 "kind", "simple"
		...
		addAnnotation
		  (getCanadianProvinceCodeType_Id(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "id",
		...
		addAnnotation
		  (getCanadianProvinceCodeType_Metadata(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "metadata",
		...
		addAnnotation
		  (getCanadianProvinceCodeType_Ref(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "ref",
		...
		addAnnotation
		  (getCanadianProvinceCodeType_RelationshipMetadata(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
		...
		addAnnotation
		  (getCanadianProvinceCodeType_AnyAttribute(), 
		   source, 
		   new String[] {
