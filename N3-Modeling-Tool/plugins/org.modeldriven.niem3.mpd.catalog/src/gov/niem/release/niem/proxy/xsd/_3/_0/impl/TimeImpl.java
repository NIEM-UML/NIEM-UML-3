 ...
 * <ul>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.TimeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.TimeImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.TimeImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.TimeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.TimeImpl#getRelationshipMetadata <em>Relationship Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.TimeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeImpl extends MinimalEObjectImpl.Container implements Time {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.TIME;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.TIME__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.TIME__ID, oldId, id));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.TIME__METADATA, oldMetadata, metadata));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.TIME__REF, oldRef, ref));
	}
	...
	public void setRelationshipMetadata(List<String> newRelationshipMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.TIME__RELATIONSHIP_METADATA, oldRelationshipMetadata, relationshipMetadata));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.TIME__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.TIME__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.TIME__VALUE:
				return getValue();
			case _0Package.TIME__ID:
				return getId();
			case _0Package.TIME__METADATA:
				return getMetadata();
			case _0Package.TIME__REF:
				return getRef();
			case _0Package.TIME__RELATIONSHIP_METADATA:
