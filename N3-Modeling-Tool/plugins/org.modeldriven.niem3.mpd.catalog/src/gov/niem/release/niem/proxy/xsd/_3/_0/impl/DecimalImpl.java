 ...
 * <ul>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DecimalImpl#getValue <em>Value</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DecimalImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DecimalImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DecimalImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DecimalImpl#getRelationshipMetadata <em>Relationship Metadata</em>}</li>
 *   <li>{@link gov.niem.release.niem.proxy.xsd._3._0.impl.DecimalImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecimalImpl extends MinimalEObjectImpl.Container implements Decimal {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.DECIMAL;
	}
	...
	public void setValue(BigDecimal newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DECIMAL__VALUE, oldValue, value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DECIMAL__ID, oldId, id));
	}
	...
	public void setMetadata(List<String> newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DECIMAL__METADATA, oldMetadata, metadata));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DECIMAL__REF, oldRef, ref));
	}
	...
	public void setRelationshipMetadata(List<String> newRelationshipMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DECIMAL__RELATIONSHIP_METADATA, oldRelationshipMetadata, relationshipMetadata));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _0Package.DECIMAL__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.DECIMAL__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.DECIMAL__VALUE:
				return getValue();
			case _0Package.DECIMAL__ID:
				return getId();
			case _0Package.DECIMAL__METADATA:
				return getMetadata();
			case _0Package.DECIMAL__REF:
				return getRef();
			case _0Package.DECIMAL__RELATIONSHIP_METADATA:
